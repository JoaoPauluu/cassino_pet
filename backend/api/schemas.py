...
class RouletteBetCreate(BaseModel):
    ...
    player: str = Field(..., description="Player id")
    number_bet: int = Field(..., ge=-1, le=36)
    color_bet: str = Field(..., description="Color of the bet: 'red', 'black', or 'none'")
...
class RouletteDrawRequest(BaseModel):
    ...
    color_draw: str = Field(..., description="Color of the drawn number: 'red', 'black', or 'green'")
